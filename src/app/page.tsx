      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Upload a POT file, translate entries, and generate PO files for
            WordPress plugins
          </p>
          <button
          ...
          >
            {showContact ? "Hide Contact Form" : "Report an Issue / Contact Us"}
          </button>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-6">
            ...
            {!potFile ? (
              ...
              <>
                ...
                <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between border-b border-gray-200 pb-4">
                  <div>
                    <div className="text-sm text-gray-500">Loaded File</div>
          ...
          {/* Sidebar Ad (only show when file is loaded) */}
          {potFile && (
        ...
        {/* In-Content Ad (between main content and info section) */}
        <div className="my-8">
          <AdBanner
            slot="in-content"
            className="w-full"
